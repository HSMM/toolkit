// Package admin — admin-only HTTP endpoints (E8 placeholder).
// Сейчас реализован только список пользователей для UI «Настройки системы →
// Пользователи». Промоут/блокировка/удаление — добавим вместе с E2.4 sync.
package admin
